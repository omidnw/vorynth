...
const launcher = [
	...
	"",
		...
		"}",
		"",
		"// v1.8.1 — tell the ESM bundle where it lives (it has no __dirname), so",
		"// web serving can find the staged frontend at <this dir>/web.",
		"process.env.VORYNTH_SIDECAR_DIR = __dirname;",
		"",
