 ...
 * Honors `#<id>` deep links from every page.
 */
			...
			<div className="min-w-0 space-y-8">
				...
				<div className="space-y-4">
					<div className="flex items-center gap-2">
						<Icon name="visibility" className="text-[24px] text-secondary" />
					...
					<p className="font-body text-body-md text-on-surface-variant">
						Vorynth never hides its reasoning. These sections explain the exact
						mechanics behind collection, ranking, Ask AI, and the brief summary
