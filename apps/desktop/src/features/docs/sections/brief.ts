...
export const briefSection: DocsSection = {
	id: "brief",
	title: "Today's Brief",
	summary: "Your ranked, readable snapshot of what matters right now — the heart of Vorynth.",
	icon: "today",
	pageRoute: "/brief",
	blocks: [
		{
		...
		},
		{
			type: "features",
			items: [
				{ icon: "sync", label: "Collect", text: "Pulls the latest articles from all enabled sources right now — no API key needed." },
				{ icon: "bolt", label: "Generate Brief", text: "Runs the AI period summary (Why It Matters / Impact / Recommended Action) over the whole period." },
				{ icon: "tune", label: "Advanced search", text: "Opens the full researcher search with structured filters." },
			],
		},
		{
			type: "features",
			items: [
				{ icon: "calendar_month", label: "Period — Today / Week / Month / All", text: "Today is the start of the current day; Week is the last 7 days; Month the last 30; All has no cutoff." },
				{ icon: "sort", label: "Sort — Newest / Most relevant / Most important", text: "Newest is by publish date, Most relevant uses the engine ranking, Most important is strictly by score. The order changes, the set stays the same." },
				{ icon: "filter_list", label: "Domains — category chips", text: "AI, Security, Cloud, Backend, DevOps, Software Engineering, Web Development, Programming Languages, Open Source, Other. Click a chip to see only that domain." },
			],
		},
		{
			type: "bullets",
			items: [
				...
				"An Original/Translated toggle appears when a title was translated.",
